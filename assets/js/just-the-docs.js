...
function initSearch() {
  ...
  request.open('GET', 'https://reclaimthewild.github.io/priv_wiki/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', 'https://reclaimthewild.github.io/priv_wiki/assets/css/just-the-docs-' + theme + '.css');
}
