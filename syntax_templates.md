...
More basic Markdown examples are available hidden on the following like :

<details markdown="block">
  <summary>
    <button type="button" name="button_open_details" class="btn btn-purple">Open!</button>
  </summary>
